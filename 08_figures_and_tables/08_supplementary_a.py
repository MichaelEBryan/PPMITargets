...
def fig2():
    ...
    panel_label(fig, ax4, "d", x=0.615)
    save(fig, "supp01_inherited_risk_and_onset")
...
def fig3():
    ...
    for a, s_ in [(ax, "a"), (ax2, "b"), (ax3, "c")]:
        panel_label(fig, a, s_)
    save(fig, "supp02_dose_not_architecture")
...
def fig4():
    ...
    save(fig, "supp19_candidate_genes")
...
def fig5():
    ...
    if len(ld):
        ...
        leader(ax, "rs979812", xy=(88.4643, -np.log10(float(ld.p_value.iloc[0]))),
    ...
    panel_label(fig, ax6, "b")
    save(fig, "supp20_galc_locus")
...
def fig6():
    ...
    panel_label(fig, axes[0], "a", dy=0.030)
    panel_label(fig, axes[1], "b", x=axes[1].get_position().x0 - 0.030, dy=0.030)
    save(fig, "supp04_classifier_separation")
