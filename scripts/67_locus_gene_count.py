...
A strong expression signal at a locus does not identify which gene is affected
if the same variant controls many genes. For each candidate locus this counts
the distinct genes for which the lead variant is a significant eQTL in any GTEx
v8 brain tissue.
"""
import os
import pandas as pd
