#!/usr/bin/env python
"""Age at onset by recruitment route and by common-variant burden.

Produces the group medians used in Figures 1 and 2: onset in carriers of a
single causal variant, by gene, and onset in patients recruited without a known
variant split into thirds of polygenic score.
"""
import json
import numpy as np
import pandas as pd
...
def main():
    ...
    # thirds of polygenic burden among patients with no known variant
