#!/usr/bin/env python
"""Direction of effect at each locus, and the GALC case."""
...
AGENT_DIR = {          # direction of the agents that exist today
...
def main():
    ...
    # a. what the risk allele does to each gene, region by region
    ...
    # b. what a drug would therefore have to do
    ...
    for i, (nm, est, lo, hi, col) in enumerate(steps):
        # each on its own scale, drawn as a fraction of the panel width
    ...
    lead(ax5, f"all {len(hi_ld)} closest\nmarkers raise GALC",
