#!/usr/bin/env python
"""Summary figure: onset by genetic cause, the three tests, the target reading."""
...
def band(fig, ax, letter, label, dy=0.016, dx=0.048):
    """Panel letter and a plain label, set on one line above the panel."""
    p = ax.get_position()
...
def main():
    ...
    # group brackets down the left margin
    ...
    # the span between the extreme thirds
    ...
    # the whole cohort, as a soft base
