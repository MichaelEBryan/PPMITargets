#!/usr/bin/env python
"""
Does the 17q21.31 haplotype regulate one gene or many?

The manuscript prefers LRRC37A2 over MAPT partly on GTEx expression. If the
variants tagging this haplotype are significant eQTLs for several genes in the
block at once, then expression data cannot separate them either, and the gene
assignment stays unresolved on both statistical and functional grounds.

We take GTEx v8 significant variant-gene pairs across all 13 brain tissues,
restrict to the 17q21.31 window, and ask which genes the haplotype regulates.
"""
...
WIN = (45_300_000, 46_600_000)          # GRCh38, 17q21.31 + flank
IDX = {"rs62053943": 45_666_837, "rs17649553": 45_917_282}
# variants in high LD with rs62053943 (|D'| >= 0.9), from the 1000G analysis
...
def main():
    ...
    # Ensembl gene id -> symbol for the block
    ...
    # the two named index variants themselves
