...
23 reaching $P < 0.05$ (Supplementary Fig.~1a, Supplementary Fig.~14e). Modelled as time to onset, the rate at which patients developed the disease rose by 1.22 per standard deviation (1.10 to 1.35, $P = 1.6\times10^{-4}$). Comparing cases
...
precision-weighted slope 1.63 $\pm$ 0.36; Supplementary Fig.~1c) while no single variant survives
correction. At
the level of individual variants comparing the two groups directly gives a combined statistic for whether any effect differs between them of $\chi^2$ = 113.5 on 90 degrees of freedom ($P$ = 0.048), which is marginal and exploratory; no
...
the onset study and from the risk study, calibrated against genes carrying the same number of variants, which left no systematic inflation ($\lambda$ = 1.000), and tested 6,259 gene sets from five databases for onset
...
the sample mean. $R^2$ on patients the model had not seen was $-$0.029 for the mean, $-$0.042 for elastic net, $-$0.052 for
...
Bank, with or without a ligand. \gene{LRRC37A2} is predicted with low confidence throughout, at a mean of 42.3 and with 77\% of residues below the level at which a predicted structure carries information, so the cavity reported in it reflects the flexibility of the chain rather than a binding site. \gene{SNCA} has no pocket above 50~\AA$^3$ at all, which is why the agents
...
mixed. The \gene{GALC} call agrees with the linkage-based analysis reported above, in which all five brain expression signals inherited together with the disease lead variant raise the gene. Of the six, an agent acting in the required direction exists for one, \gene{GPNMB}
...
structures sit within 1~\AA{} C$\alpha$ root-mean-square deviation of wild type, and the largest change in the predictor's mean confidence across all 53 is 1.03 points (Supplementary Fig.~16).
...
% ---------------------------------------------------------------- figures ----
\figpage{../figures/fig01_summary.pdf}{\figlead{Fig.~1}Summary of the study. \textbf{a},~Age at first motor symptom for each genetic
...
\figpage{../figures/fig02_onset.pdf}{\figlead{Fig.~2}Age at onset in PPMI. \textbf{a},~Age at first motor symptom for all 2,107
...
\figpage{../figures/fig03_expression.pdf}{\figlead{Fig.~3}Effect of the Parkinson's risk allele on gene expression in brain.
...
\figpage{../figures/fig04_targets.pdf}{\figlead{Fig.~4}What would make any of these genes a drug target. \textbf{a},~Predicted
...
\figpage{../figures/fig05_attribution.pdf}{\figlead{Fig.~5}What the earlier classifier attends to, from its Shapley attributions in the
...
\figpage{../figures/supp01_inherited_risk_and_onset.pdf}{\figlead{Supplementary Fig.~1}Inherited risk and age at onset. \textbf{a},~Years of onset brought forward per
...
\figpage{../figures/supp02_dose_not_architecture.pdf}{\figlead{Supplementary Fig.~2}Early and late onset differ in dose, not architecture. \textbf{a},~Polygenic
...
\figpage{../figures/supp03_direction_of_effect.pdf}{\figlead{Supplementary Fig.~3}Direction of effect and the \gene{GALC} case. \textbf{a},~Effect of the risk
...
\figpage{../figures/supp04_classifier_separation.pdf}{\figlead{Supplementary Fig.~4}What the earlier classifier separates, in the early stratum (\textbf{a}) and the
late stratum (\textbf{b}). Each row is a feature block; points are the three
model families.}

\figpage{../figures/supp05_effect_sizes.pdf}{\figlead{Supplementary Fig.~5}Effect sizes of real Parkinson's risk variants against the sensitivity of the
...
\figpage{../figures/supp06_ranking_rule.pdf}{\figlead{Supplementary Fig.~6}Operating characteristics of the ranking comparison and of a formal
...
\figpage{../figures/supp07_false_positive_surface.pdf}{\figlead{Supplementary Fig.~7}False-positive rate under identical architecture by group size and effect size,
for the ranking rule (\textbf{a}) and the formal test (\textbf{b}).}

\figpage{../figures/supp08_shared_feature_null.pdf}{\figlead{Supplementary Fig.~8}The earlier selection procedure applied within a single stratum.
...
\figpage{../figures/supp09_feature_ablation.pdf}{\figlead{Supplementary Fig.~9}The full feature-block ablation in PPMI, in the early stratum (\textbf{a}) and
the late stratum (\textbf{b}).}

\figpage{../figures/supp10_gene_sets_and_models.pdf}{\figlead{Supplementary Fig.~10}Gene sets and models. \textbf{a},~Null of the maximum statistic across 6,259 gene
sets under 20,000 genome rotations. \textbf{b},~Held-out $R^2$ for onset age by
model class. \textbf{c},~Learning curves.}

\figpage{../figures/supp11_variant_effect_auc.pdf}{\figlead{Supplementary Fig.~11}Area under the curve for separating ClinVar pathogenic from gnomAD common
substitutions in \gene{GALC}, by method.}

\figpage{../figures/supp12_17q21_haplotype.pdf}{\figlead{Supplementary Fig.~12}Linkage disequilibrium of rs62053943 across chr17:44.8--46.6~Mb, as $r^2$
(\textbf{a}) and $|D'|$ (\textbf{b}), with the gene track (\textbf{c}).}

\figpage{../figures/supp13_recruitment_routes.pdf}{\figlead{Supplementary Fig.~13}How PPMI participants reached the study. \textbf{a},~Recruitment route by onset
...
\figpage{../figures/supp14_robustness_checks.pdf}{\figlead{Supplementary Fig.~14}Robustness diagnostics: permutation resolution (\textbf{a}), gene-level
calibration (\textbf{b}), how often the test fires when it should not, with and without correlation between variants (\textbf{c}),
the interaction null (\textbf{d}), the specification curve (\textbf{e}) and
leave-one-out for the lysosomal enrichment (\textbf{f}).}

\figpage{../figures/supp15_claim_audit.pdf}{\figlead{Supplementary Fig.~15}Claim-by-claim audit: each row a claim from this work and each column a check
that could break it.}

\figpage{../figures/supp16_galc_structure.pdf}{\figlead{Supplementary Fig.~16}ESMFold and AlphaFold predictions for \gene{GALC} wild type against 53 single
substitutions.}

\figpage{../figures/supp17_enrolment_proxy.pdf}{\figlead{Supplementary Fig.~17}The same onset analyses run on age at enrolment, the proxy used in the earlier
analysis.}

\figpage{../figures/supp18_attribution_stability.pdf}{\figlead{Supplementary Fig.~18}Stability of the attributions. \textbf{a},~Probability a feature stays in the top
...
\figpage{../figures/supp19_candidate_genes.pdf}{\figlead{Supplementary Fig.~19}Candidate genes ranked by evidence that they act on age at onset, with Open
Targets tractability and agents in development.}

\figpage{../figures/supp20_galc_locus.pdf}{\figlead{Supplementary Fig.~20}The \gene{GALC} locus. \textbf{a},~Regional association with the gene track
